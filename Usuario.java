...
public class Usuario // La linea 1 explica como guardar y bajar usuarios de la BD. Desplegar para ver
{
		    ...
		    else
		    {
				...
				try
				{
			    	...
			    	if (opcion.equals("1"))
			    	{
			    		...
			    		else // Falta a�adir fila "usuario,IDdeevento" a "eventosFavoritos.csv"
			    		{
	...
	public void mostrarFicha() throws IOException
	{
		...
		do
		{
			...
			//faltar�a opcion de enviarle por correo uno de tus eventos favoritos
	...
	{
		System.out.println("Le recordamos que no podr� asistir a ciertos" +
	...
	public void DarseBaja() throws IOException
	{
		...
		System.out.println("Est� seguro que desea darse de baja?");
	...
	{ 
		...
		Scanner reader = new Scanner(tablaUsuarios); //Le paso como par�metro el fichero que quiero leer
